...
typeOfPay.setAttribute('style','margin-bottom: 10px;');clientComment.setAttribute('style','margin-bottom: 10px;');message.append(typeOfPay);message.append(clientComment);message.append(table);let nowDate=new Date().toLocaleDateString();let nowTime=new Date().toLocaleTimeString();function createDataTableBody(info){let tableRow=document.createElement('tr');tableRow.setAttribute('style','border: 1px solid black; text-align: center; font-size: 15px;');let tableDataCode=document.createElement('td');tableDataCode.append(info.cd);tableDataCode.setAttribute('style','border: 1px solid black; text-align: center; padding: 5px;');tableRow.append(tableDataCode);let tableDataName=document.createElement('td');tableDataName.append(info.ttl);tableDataName.setAttribute('style','border: 1px solid black; text-align: center; padding: 5px;');tableRow.append(tableDataName);let tableDataCount=document.createElement('td');tableDataCount.append(info.cnt);tableDataCount.setAttribute('style','border: 1px solid black; text-align: center; padding: 5px;');tableRow.append(tableDataCount);let tableDataPrice=document.createElement('td');tableDataPrice.append(info.prc);tableDataPrice.setAttribute('style','border: 1px solid black; text-align: center; padding: 5px;');tableRow.append(tableDataPrice);return tableRow;}
function createDataTableSummary(summary,count){let tableRow=document.createElement('tr');tableRow.setAttribute('style','border: 1px solid black; text-align: center; font-size: 15px;');let tableDataResult=document.createElement('td');tableDataResult.append('итого');tableDataResult.setAttribute('style','border: 1px solid black; text-align: center; padding: 5px; font-weight: bold;');tableDataResult.setAttribute('colspan','2');tableRow.append(tableDataResult);let tableDataCountResult=document.createElement('td');tableDataCountResult.append(count);tableDataCountResult.setAttribute('style','border: 1px solid black; text-align: center; padding: 5px; font-weight: bold;');tableRow.append(tableDataCountResult);let tableDataPriceResult=document.createElement('td');tableDataPriceResult.append(summary.toFixed(2));tableDataPriceResult.setAttribute('style','border: 1px solid black; text-align: center; padding: 5px; font-weight: bold;');tableRow.append(tableDataPriceResult);return tableRow;}
