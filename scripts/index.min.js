...
clear(){Swal.fire({title:"Очистить всё?",icon:"question",showCancelButton:true,confirmButtonColor:"#3085d6",cancelButtonColor:"#d33",confirmButtonText:"Да, очистить!",cancelButtonText:"Отмена"}).then((result)=>{if(result.isConfirmed){sessionStorage.setItem('inCart',[0]);location.reload();}});}
